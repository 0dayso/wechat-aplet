...
function getCityName(latitude, longitude, callback) {
    ...
    var apiURL = "http://api.map.baidu.com/geocoder/v2/?ak=UZGyVpfedXxVYSnWyVSd96sYl0zglLQQ&output=json&pois=1&location="+ latitude + "," + longitude;
...
// https://darksky.net/35,105
    var apiKey = "af9842184035692ca648e3bb340af642";
